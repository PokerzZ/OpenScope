...
# ChatDev/puppeteer/tools/utils/broswer.py -> ChatDev/puppeteer/
...
if os.path.exists(config_path):
    ...
    # Fallback for when running from different directories or if file missing
    # Try relative path if absolute fails, though absolute is safer
    try:
        global_config = yaml.safe_load(open("./config/global.yaml", "r"))
    except FileNotFoundError:
        print(f"Warning: Config file not found at {config_path} or ./config/global.yaml")
        global_config = {}
