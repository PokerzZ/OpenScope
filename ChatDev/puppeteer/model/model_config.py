...
MODEL_REGISTRY: Dict[str, ModelConfig] = {
    ...
    "qwen-plus": ModelConfig(
        name = "qwen-plus",
        function_name="query_qwen_plus",
        api_model_name="qwen-plus",
        provider="openai",
        model_size=72, # estimated
        max_tokens=30000, # qwen-plus supports up to 32k context usually, or more depending on version
        description="Alibaba Cloud Qwen-Plus model"
    ),
