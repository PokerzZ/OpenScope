...
from tasks import mmlu_pro, gsm_hard, srdd, creative_writing, opendigger_task, opendigger_mmlu

def main():
    parser = argparse.ArgumentParser(description="Run benchmark tasks")
    parser.add_argument("task", choices=["MMLU-Pro", "gsm-hard", "SRDD", "CW", "OpenDigger", "OpenDiggerMMLU"])
    parser.add_argument("mode", choices=["validation", "test", "train"])
    ...
    task_map = {
        ...
        "OpenDigger": opendigger_task.run,
        "OpenDiggerMMLU": opendigger_mmlu.run,
    }
