...
# ChatDev/puppeteer/inference/reasoning/path.py -> ChatDev/puppeteer/
...
class GraphReasoningPath:
    ...
    def update_global_info(self, current_action):
        ...
        # Log the action as JSON for the frontend to parse
        action_dict = current_action.to_dict()
        action_dict['path_id'] = self.index
        self.logger.info(json.dumps(action_dict))
